...
const CrearNominaIncubadoraDialog: React.FC<Props> = ({ open, onClose, onCreated }) => {
  ...
  const totalGeneral = pendientes.reduce((s, e) => s + e.pago_total, 0);
  ...
  const guardar = async () => {
    ...
    try {
      await axios.post(
        ...
        { etiqueta: etiqueta.trim(), datos: pendientes },
        { headers: authH() },
      );
      onCreated();
    } catch (err: any) {
    ...
    <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
      ...
      <DialogContent dividers>
        ...
        <Alert
          ...
          sx={{ mb: 2, fontSize: 13 }}
        >
          Al guardar, estos chips se marcarán como pagados y no aparecerán en futuras nóminas.
        </Alert>
            ...
            <Table size="small">
              ...
              <TableBody>
                ...
                <TableRow sx={{ bgcolor: "#ede9fe" }}>
                  ...
                  <TableCell sx={{ fontWeight: 700, fontSize: 13, color: PURPLE }}>
      ...
      <DialogActions sx={{ px: 3, pb: 2 }}>
        ...
        <Button
          variant="contained"
          onClick={guardar}
          disabled={!etiqueta.trim() || pendientes.length === 0 || cargando || guardando}
